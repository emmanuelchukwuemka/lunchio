<x-guest-layout>
    <div class="mb-10 text-center sm:text-left">
        ...
        <p class="mt-3 text-base text-slate-500">Get started by filling out the information below.</p>
    </div>
    ...
    <div class="relative mt-8 mb-8">
        ...
        <div class="relative flex justify-center text-sm font-medium leading-6">
            <span class="bg-white px-6 text-slate-400 uppercase tracking-widest text-xs font-bold">Or continue with</span>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="block text-xs font-bold uppercase tracking-widest text-slate-700">Full Name</label>
        ...
        <div>
            ...
            <div class="mt-2.5 relative">
                ...
                <input id="password" type="password" name="password" required autocomplete="new-password" class="block w-full rounded-2xl border-0 py-3.5 pl-11 pr-4 bg-slate-50 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all font-medium">
            </div>
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-xs font-bold uppercase tracking-widest text-slate-700">Confirm Password</label>
            <div class="mt-2.5 relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <p class="mt-10 text-center text-sm text-slate-500 font-medium">
            Already registered?
            <a href="{{ route('login') }}" class="font-bold text-brand-600 hover:text-brand-700 transition">Log in to your account &rarr;</a>
        </p>
    </form>
</x-guest-layout>
